...
import { mainListItems, secondaryListItems } from '../painel_controle/listItems';
import Lista from "./simple_list"
...
const drawerWidth = 300; //espacamento do dropleft menu
...
const useStyles = makeStyles((theme) => ({
  ...
  toolbar: {
    paddingRight: 26, // keep right padding when drawer closed
  },
  toolbarIcon: {
    display: 'flex',
    alignItems: 'center',
